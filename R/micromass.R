...
#'
#' @format A list with 10 groups of gram, each of which includes data from two species. There are 1300 variables in each group, characterizing the features of the gram. The pair of species contained in eac group:
#' \itemize{
